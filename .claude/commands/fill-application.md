...
If no folder is given, the autofiller will fall back to the global `~/path/to/job-search/inputs/standard_answers.md` for field values and ask James which resume / cover-letter PDFs to upload.
