...
- **Don't add a Workable or Ashby row** until those adapters are implemented in `src/job_finder/adapters/`. The collector will silently skip unknown providers with an error in stats.
