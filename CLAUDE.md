...
- **CLI:**
  ```sh
  job-finder outreach add --name "Varun" --company "ZoomInfo" [--role "…"] [--type connection-request|message|hm-message] [--notes "…"] [--date YYYY-MM-DD]
  job-finder outreach list [--company zoominfo]
  job-finder outreach remove --name "Devin Hua" --company "Axon"   # exact name+company, case-insensitive
  ```
