...
def _render_cover_letter(skill_path: Path, cover_letter: dict, output_pdf: Path) -> None:
    ...
    doc = SimpleDocTemplate(
        ...
        title="James Simonelli — Cover Letter",
        author="James Simonelli",
        subject="Product Management Cover Letter",
        creator="James Simonelli",
    )

    story = []
    title_subtitle = cover_letter.get("title_subtitle", "Principal Product Manager | AI, Platforms & Consumer Products")
    story.append(Paragraph("James Simonelli", s["name_header"]))
    story.append(Paragraph(title_subtitle.replace("&", "&amp;"), s["title_header"]))
    story.append(Paragraph(
        '925-953-3894  &middot;  <a href="mailto:James.Simonelli@outlook.com" color="#2C5F8A">James.Simonelli@outlook.com</a>'
        '  &middot;  <a href="https://www.linkedin.com/in/james-simonelli-86477a157/" color="#2C5F8A">LinkedIn</a>',
        s["contact_header"]
    ))
    ...
    story.append(Paragraph("James Simonelli", s["sig_name"]))
    story.append(Paragraph(
        '<a href="mailto:James.Simonelli@outlook.com" color="#2C5F8A">James.Simonelli@outlook.com</a>  ·  925-953-3894',
        s["sig_contact"]
    ))
...
def render(
    *,
    ...
    resume_pdf = outdir / f"James_Simonelli_Resume_{company_slug}.pdf"
    cover_pdf = outdir / f"James_Simonelli_CoverLetter_{company_slug}.pdf"
...
TAILOR_SYSTEM = """You are James Simonelli's resume + cover letter tailoring assistant.
