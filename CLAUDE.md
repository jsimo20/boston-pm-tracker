...
- Field values come from `profile/profile.toml` (identity, EEO, work-auth stance) plus `standard_answers.md` in the configured `inputs_dir` (for James: `~/OneDrive/Documents/Job Search/2026/inputs/`, set in `profile/profile.toml [paths]`).
